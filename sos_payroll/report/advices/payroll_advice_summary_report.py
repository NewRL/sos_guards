...
class GuardPayrollAdviceSummaryReport(models.AbstractModel):
	_name = 'report.sos_payroll.guards_payroll_advice_summary_report'
	_description = 'Guards Payroll Advice Summary Report'
	...
	def _get_report_values(self, docids, data=None):
		...
		advice = self.env['guards.payroll.advice'].search([('id','=',advice_id)])
		...
		report = self.env['ir.actions.report']._get_report_from_name('sos_payroll.guards_payroll_advice_summary_report')
		return {
			'doc_ids': self._ids,
